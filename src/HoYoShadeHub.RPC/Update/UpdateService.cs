...
internal class UpdateService
{
    ...
    public async Task UpdateAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            _logger.LogInformation("Update HoYoShadeHub finished");
        }
        catch (OperationCanceledException)
        {
            _logger.LogInformation("Update HoYoShadeHub canceled, restore version.ini");
            State = UpdateState.Stop;
            RestoreVersionIni();
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Update HoYoShadeHub failed, restore version.ini");
    ...
    private async Task DownloadFilesAsync(CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation("Update HoYoShadeHub, downloading {count} files, file size: {size}", Progress_TotalFileCount, Progress_TotalBytes);
        ...
        _logger.LogInformation("Update HoYoShadeHub, downloading files finished");
    }
    ...
    {
        _logger.LogInformation("Update HoYoShadeHub, patching and verifying files");
