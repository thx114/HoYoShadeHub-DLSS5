...
internal static class HotkeyManager
{
    ...
    public static HotkeyInfo ShowMainWindow { get; private set; } = new HotkeyInfo(nameof(AppConfig.ShowMainWindowHotkey), 44444, User32.HotKeyModifiers.MOD_ALT, User32.VK.VK_H);
    ...
    public static void InitializeHotkey(nint hwnd)
    {
        try
        {
            foreach (var item in new HotkeyInfo[] { ShowMainWindow })
            {
