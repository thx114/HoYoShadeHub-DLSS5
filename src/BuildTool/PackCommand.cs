...
public class PackCommand
{
    ...
    public Command Command { get; set; } = new Command("pack", "Pack HoYoShadeHub files.");

    private Argument<string> rootPathArgument = new Argument<string>("rootPath") { Description = "The root path of the HoYoShadeHub build files.", DefaultValueFactory = (_) => "./build/HoYoShadeHub" };
    ...
    public async Task Pack(ParseResult parseResult)
    {
        ...
        Console.WriteLine($"Packing HoYoShadeHub build ({version}, {arch}, {type}): {rootPath}");
